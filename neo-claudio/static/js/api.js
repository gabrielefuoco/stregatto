...
export class CatAPI {
    ...
    static async cancelAgentMessage(agentSlug = 'default', payload = {}) {
        return this.fetch(`/agents/${agentSlug}/cancel`, {
            method: 'POST',
    ...
    static async streamMessage(messagesPayload, agentSlug = 'default', onEvent, options = {}) {
        const session = await getSession();
        ...
        try {
            ...
            if (error.name === 'AbortError') {
                console.log("[api.js] Stream aborted by client.");
                return;
            }
    ...
    static async getModels() {
        try {
            ...
            console.warn("Could not fetch models from /llms:", e);
        }
